...
public class AdminStudentSearchFrame extends JFrame implements ActionListener{
	
	JLabel j1,j2,j3;
	JTextField t1,t2;
	JButton b1,b2,b3;
	
	AdminStudentSearchFrame(){
        ...
        j1 = new JLabel("Admin Student Search Frame");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (src == b1) {
            Student_Panel student = Admin_Panel.search_student(t1.getText(), t2.getText());
            if (student != null) {
                dispose();
                StudentProfileViewFrame p = new StudentProfileViewFrame(student);
            }
