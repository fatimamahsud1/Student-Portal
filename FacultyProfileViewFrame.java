...
public class FacultyProfileViewFrame extends JFrame implements ActionListener{
	JLabel j1,j2,j3,j4,j5,j6,j7,j8,j9,j10;
	JButton b1,b2,b3;
	Faculty_Panel  faculty;
	
	public FacultyProfileViewFrame(Faculty_Panel faculty) {
		setLayout(null);
        setSize(1200, 700);
        setResizable(false);
        ...
        b1 = new JButton("OK");
        b1.setBounds(250, 650, 80, 30);
        add(b1);
        b1.addActionListener(this);
        
        b2 = new JButton("Exit");
        b2.setBounds(410, 650, 70, 30);
        add(b2);
