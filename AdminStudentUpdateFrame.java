...
public class AdminStudentUpdateFrame extends JFrame implements ActionListener{
	
	JLabel j1,j2,j3;
	JTextField t1,t2;
	JButton b1,b2,b3;
	
	AdminStudentUpdateFrame(){
        ...
        j1 = new JLabel("Admin Student Update Frame");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (src == b1) {
			Student_Panel student = Student_Panel.getStudent(t1.getText(), t2.getText());
			AdminStudentUpdateProfileFrame a = new AdminStudentUpdateProfileFrame(student);
		}
		else if (src == b2) {
			dispose();
