...
public class AdminFacultyDeleteFrame extends JFrame implements ActionListener{
	
	JLabel j1,j2,j3;
	JTextField t1,t2;
	JButton b1,b2,b3;
	
	AdminFacultyDeleteFrame(){
        ...
        j1 = new JLabel("Admin Faculty Delete Frame");
        j1.setBounds(200, 10, 250, 100);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (src == b1) {
			Admin_Panel.delete_faculty(t1.getText(), t2.getText());
			JOptionPane.showMessageDialog(null, "Faculty's record deleted successfully!");
		}
		else if (src == b2) {
			dispose();
