...
//import Admin_Panel;
//import Faculty_Panel;

public class AdminFacultyAddFrame extends JFrame implements ActionListener{
	
	JLabel j1,j2,j3,j4,j5,j6,j7,j8,j9;
    JTextField t1,t2,t3,t4,t5,t6,t7,t8;
    JButton b1,b2;
	
	public AdminFacultyAddFrame(){
        ...
        j1 = new JLabel("Admin Faculty Add Frame");
        ...
        b1 = new JButton("Back");
        b1.setBounds(170,590,70,30);
        b1.addActionListener(this);
        add(b1);
        
        b2 = new JButton("Submit");
        b2.setBounds(320, 590, 80, 30);
        add(b2);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (src == b1) {
			...
			Faculty_Panel f = new Faculty_Panel(t1.getText(), t2.getText(), t3.getText(), t4.getText(), t5.getText(), t6.getText(), t7.getText(),username,password,t8.getText());
			Faculty_Panel.writeFaculty(f);
			JOptionPane.showMessageDialog(null, "Faculty's ID is: " + username + "\nFaculty Successfully Created!");
		}
	}
}
