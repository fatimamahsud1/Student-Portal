...
public class AdminFacultyUpdateFrame extends JFrame implements ActionListener{
	
	JLabel j1,j2,j3;
	JTextField t1,t2;
	JButton b1,b2,b3;
	
	AdminFacultyUpdateFrame(){
        ...
        j1 = new JLabel("Admin Faculty Update Frame");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (src == b1) {
			Faculty_Panel faculty = Faculty_Panel.getFaculty(t1.getText(), t2.getText());
			AdminFacultyUpdateProfileFrame a = new AdminFacultyUpdateProfileFrame(faculty);
		}
		else if (src == b2) {
			dispose();
