...
public class AdminStudentUpdateProfileFrame extends JFrame implements ActionListener{
	...
	public AdminStudentUpdateProfileFrame(Student_Panel student){
		setLayout(null);
        setSize(1200, 700);
        //setResizable(false);
        ...
        j1 = new JLabel("Update Student Profile");
        ...
        b1 = new JButton("Back");
        b1.setBounds(110,710,70,30);
        b1.addActionListener(this);
        add(b1);
        
        b2 = new JButton("Submit");
        b2.setBounds(240, 710, 80, 30);
        add(b2);
        b2.addActionListener(this);
        
        b3 = new JButton("Exit");
        b3.setBounds(380, 710, 70, 30);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (src == b1) {
			...
			dispose();
			Student_Panel.updateProfile(t1.getText(), t2.getText(), t3.getText(), t4.getText(), t5.getText(), t6.getText(), t7.getText(), Boolean.parseBoolean(t8.getText()));
